...
class IProneEBook extends EBook { showInfo() { console.log("EBook: IProne PadRead"); } }
...
class BalaxySmartphone extends Smartphone { showInfo() { console.log("Smartphone: Balaxy S24 Ultra"); } }
