...
class Director {
    constructDreamHero(builder) {
        return builder
            ...
            .setHairColor("Темне")
            .setEyeColor("Зелені")
            .setClothes("Обладунки")
            .addInventoryItem("Меч")
            .addInventoryItem("Магічний щит")
            .addGoodDeed("Врятувала місто")
            .addGoodDeed("Врятувала кошенятко")
            .build();
    }
    ...
    constructWorstEnemy(builder) {
        return builder
            ...
            .setBuild("Повна")
            .setHairColor("Чорне")
            .setEyeColor("Сіро-карі")
            .setClothes("Плащ")
            .addInventoryItem("Лук з палаючими стрілами")
            .addEvilDeed("Захопила місто")
            .addEvilDeed("Закинула кошеня на дерево")
            .build();
    }
}
